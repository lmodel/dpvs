...
# Import map: rewrites canonical URI imports (e.g. `dpv:schema/dpv_core`) to
...
# `dpv:schema/dpv_core` to be fetched over HTTP (404 against
...
_clean_project:
    ...
    # aggregate `dpv_core.yaml`, every per-module schema under `modules/`,
