...
URI: [risk:RM7x7S4L1](https://w3id.org/lmodel/dpv/risk/RM7x7S4L1)
        ...
        * [RiskAnalysis](RiskAnalysis.md)
            * [RiskMatrix](RiskMatrix.md)
                * [RiskMatrix7x7](RiskMatrix7x7.md) [ [RiskAnalysis](RiskAnalysis.md)]
                    * **RM7x7S4L1** [ [RiskAnalysis](RiskAnalysis.md)]
...
| Property | Value |
| --- | --- |
| Class URI | [risk:RM7x7S4L1](https://w3id.org/lmodel/dpv/risk/RM7x7S4L1) |
...
| property | value |
| --- | --- |
| upstream_iri | https://w3id.org/dpv/risk/owl#RM7x7S4L1 |
...
| ---  | ---  |
| self | risk:RM7x7S4L1 |
| native | risk:RM7x7S4L1 |
| exact | dpv_risk:RM7x7S4L1, dpv_risk_owl:RM7x7S4L1 |
...
annotations:
  upstream_iri:
    tag: upstream_iri
    value: https://w3id.org/dpv/risk/owl#RM7x7S4L1
  dpv_extension_slug:
...
exact_mappings:
- dpv_risk:RM7x7S4L1
- dpv_risk_owl:RM7x7S4L1
is_a: RiskMatrix7x7
mixins:
- RiskAnalysis
class_uri: risk:RM7x7S4L1
